...
def drug_history(request, drug=None):
    ...
    return render(request, 'pos/drug_history.html',
    {
        'getDrug': getDrug, 
        'products': products, 
...
def supply_history(request):
    ...
    return render(request, 'pos/supply_hisotry.html',
    {
        'supplies': supplies,
    })
...
def statistics(request):
    products = Product.objects.filter(available_quantity=0)
    return render(request, "pos/statistics.html",{"products":products,})